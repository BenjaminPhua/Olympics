...
public class DatabaseBackend {
    ...
    public HashMap<String, Object> getMemberDetails(String memberID) throws OlympicsDBException {
    	...
    	/**
    	 * The SQL as a placeholder for it (Current not correct @Johnny 25/05/17
SELECT member_id, place_name as accommodation_location,  COUNT(booked_by) as number_of_bookings
FROM olympics.member JOIN olympics.accommodation ON (accommodation = place_id) JOIN olympics.place USING (place_id) JOIN olympics.booking ON (member_id = booked_for)
WHERE member_id = 'A00029984' 
GROUP BY member_id, place_name
